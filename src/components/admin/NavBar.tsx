...
import { FiChevronDown, FiBell, FiSearch, FiUser, FiSettings, FiLogOut, FiShield, FiFileText } from "react-icons/fi";
    ...
    <nav className="w-full bg-gray-900 text-white shadow-lg px-6 py-3 flex justify-between items-center border-b border-gray-700">
      ...
      <div className="flex items-center space-x-4">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-xl font-semibold tracking-tight">DILG eGov Nexus</span>
        </div>
      </div>
