      ...
      >
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            ...
            >
              <button className="bg-cyan-500 hover:bg-cyan-600 px-8 py-4 rounded-lg font-semibold text-lg transition-all hover:scale-105">
                Get Started
              </button>
              <button className="border border-cyan-500 text-cyan-500 hover:bg-cyan-500/10 px-8 py-4 rounded-lg font-semibold text-lg transition-all hover:scale-105">
                Watch Demo
              </button>
            </motion.div>
          </div>
          ...
          >
            ...
            <div className="relative bg-gray-900 h-90 rounded-2xl p-6 shadow-2xl transform group-hover:-translate-y-2 transition-transform">
              <div className="bg-gray-800 rounded-xl overflow-hidden">
                {/* Mock Dashboard Content */}
                <div className="h-85 bg-gradient-to-br from-gray-900 to-gray-800 flex items-center justify-center">
