    ...
    <div className={`transition-colors duration-300 ${darkMode ? 'dark' : ''}`}>
      ...
      <div className="fixed top-6 right-6 z-50">
        <button
          ...
          className="p-3 rounded-full bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-700 hover:scale-110 transition-all duration-300"
        >
          {darkMode ? (
